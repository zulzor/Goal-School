...
console.log('Инструкции по созданию APK для RuStore');
...
// Создаем папку для инструкций если её нет
const instructionsDir = path.join(__dirname, 'apk-instructions');
if (!fs.existsSync(instructionsDir)) {
  fs.mkdirSync(instructionsDir, { recursive: true });
}

// Сохраняем инструкции в файл
const instructionsPath = path.join(instructionsDir, 'HOW_TO_BUILD_APK.md');
fs.writeFileSync(instructionsPath, instructions);

console.log('Инструкции по созданию APK сохранены в файл:');
