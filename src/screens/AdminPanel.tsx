...
export const AdminPanel: React.FC = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* New section for subscription management */}
      <Card style={styles.card}>
        <Card.Content>
          <Title>Управление абонементами</Title>
          <Paragraph>Создание и управление абонементами для учеников.</Paragraph>
          <ArsenalButton
      ...
      {/* New section for branch management */}
      <Card style={styles.card}>
        <Card.Content>
          <Title>Управление филиалами</Title>
          <Paragraph>Создание филиалов и управление переводами семей и тренеров.</Paragraph>
          <ArsenalButton
            title="Управление филиалами"
            variant="primary"
            onPress={() => navigation.navigate('BranchTransfer' as never)}
            style={styles.button}
          />
        </Card.Content>
      </Card>

      {/* New section for training management */}
      <Card style={styles.card}>
        <Card.Content>
          <Title>Управление тренировками</Title>
          <Paragraph>Планирование тренировок и управление их отменой.</Paragraph>
          <ArsenalButton
            title="Управление тренировками"
            variant="primary"
            onPress={() => navigation.navigate('TrainingManagement' as never)}
            style={styles.button}
          />
        </Card.Content>
      </Card>
