  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const mockSkills = [
          { id: '1', name: 'Ведение мяча', category: 'technical', level: 75 },
          { id: '2', name: 'Удар по воротам', category: 'technical', level: 60 },
          { id: '3', name: 'Физическая подготовка', category: 'physical', level: 80 },
          { id: '4', name: 'Тактическое мышление', category: 'tactical', level: 55 },
          { id: '5', name: 'Командная работа', category: 'social', level: 70 },
        ];
        ...
        const mockGoals = [
          ...
          {
            id: '2',
            title: 'Повысить физическую подготовку',
            description: 'Увеличить выносливость и силу',
            status: 'active',
          ...
          {
            id: '3',
            title: 'Освоить новые тактические схемы',
            description: 'Изучить позиционную игру',
            status: 'completed',
        ...
        const mockFeedback = [
          {
            id: '1',
            name: 'Тренировка по технике',
            description:
              'Показал хорошие результаты в упражнениях на ведение мяча. Рекомендую продолжать работу над ударом по воротам.',
            rating: 4,
          },
          {
            id: '2',
            ...
            description:
              'Проявил лидерские качества в командных упражнениях. Нужно улучшить позиционирование на поле.',
            rating: 5,
          },
          {
            id: '3',
            name: 'Физическая подготовка',
            description: 'Отличная физическая форма. Продолжай в том же духе!',
            rating: 5,
          },
        ];
